...
let deepCopyUser = {...user, friend: [...user.friends]}
...
let deepCopyStudents = students.map(st => ({...st})) // скобки груглые чтобы не ругался
...
let newDeepCopyStudents = [...topStudents, ...deepCopyStudents] //можно concat
